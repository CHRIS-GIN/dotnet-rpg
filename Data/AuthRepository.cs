...
namespace dotnet_rpg.Data
{
    public class AuthRepository : IAuthRepository
    {
        ...
        private string CreateToken(User user)
        {
            ...
            SymmetricSecurityKey key = new SymmetricSecurityKey(System.Text.Encoding.UTF8//add package 
            ...
            JwtSecurityTokenHandler tokenHandler = new JwtSecurityTokenHandler();//add package
